...
To describe the balancing act of \gls{glos:liquidity} and
\gls{glos:profitability} as a trade-off between short-term survival and
realization of the ultimate goal of a firm is too simplistic. As a result,
section \vref{sec:LiteratureReview} will add a number of influencing concepts
such as risk-return theory, term, size of company, industry and other factors.
Section \vref{sec:Application} will review verify these findings at the example
of one industry. Section \vref{sec:PracticalExperience} will add our own
experiences to review the remaining hypotheses  both from a \gls{sme} and a
large corporation. Section \vref{sec:Conclusions} concludes with an attempt to
answer the question.

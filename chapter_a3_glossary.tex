...
\def\glosdescaccrualsaccounting{``Accruals accounting is preparing the income statement and statement of financial position following the accruals convention, which says that profit = revenue - expenses (not cash receipts - cash payments).'' \citep[107]{Atrill:2011qy}}
